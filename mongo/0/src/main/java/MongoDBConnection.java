...
public class MongoDBConnection {
    ...
    private static final String USERNAME = "felipeanias";
    private static final String PASSWORD = "felipeanias-123";
    private static final String CLUSTER_URL = "cluster0.r9vcvfc.mongodb.net"; // Substitua pelo seu cluster se for diferente
